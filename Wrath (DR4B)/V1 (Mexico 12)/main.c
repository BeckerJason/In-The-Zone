...
#pragma config(Motor,  port1,           roller,        tmotorVex393_HBridge, openLoop, reversed)
#pragma config(Motor,  port2,           R1,            tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port3,           RM,            tmotorVex393HighSpeed_MC29, openLoop, encoderPort, I2C_1)
...
#pragma config(Motor,  port8,           LM,            tmotorVex393HighSpeed_MC29, openLoop, encoderPort, I2C_2)
