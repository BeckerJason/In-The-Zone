...
{//VOLTAGE COMPENSATION-------------------------
	...
	if (vexRT[Btn7U]==1)
	{
		while (abs(SensorValue[enc])>15&&vexRT[Btn5D]==0 )
		{motor[ClawM]=127*PMult;}}
	else if(vexRT[Btn8R]==1)
	{
		while (abs(SensorValue[enc])>450&&vexRT[Btn5D]==0)
		{motor[ClawM]=127*PMult;}
		while (abs(SensorValue[enc])<430&&vexRT[Btn5D]==0)
		{motor[ClawM]=-127*PMult;}
	}
	...
	else if (vexRT[Btn6U]==1&&vexRT[Btn6D]==0){motor[ClawM]=127*PMult;}
	else if (vexRT[Btn6D]==1&&vexRT[Btn6U]==0){motor[ClawM]=-127*PMult;}
	else{motor[ClawM]=10;}

	if (vexRT[Btn8D]==1&&vexRT[Btn8U]==0){motor[MG]=100*PMult;}
	else if (vexRT[Btn8U]==1&&vexRT[Btn7D]==0){motor[MG]=-127*PMult;}
	else{motor[MG]=15*PMult;}
	//CLAW
	if (vexRT[Btn5U]==1){SensorValue[claw]=1;}
