...
if(abs(vexRT[Ch3])>10 && vexRT[Btn8L]==0 || abs(vexRT[Ch4])>10 && vexRT[Btn5U]==0)
{
	...
	motor[rightDriveBack]=(vexRT[Ch3]-(vexRT[Ch4]*.53));
	motor[powerCD]=(vexRT[Ch3]-(vexRT[Ch4]*.53));
	motor[rightDriveFrontMID]=(vexRT[Ch3]-(vexRT[Ch4]*.53));
	motor[leftDriveBack]=(vexRT[Ch3]+(vexRT[Ch4]*.53));
	motor[powerAB]=(vexRT[Ch3]+(vexRT[Ch4]*.53));
	motor[leftDriveFrontMID]=(vexRT[Ch3]+(vexRT[Ch4]*.53));
...
if(vexRT[Btn8L]==1||vexRT[Btn5U]==1)
{SensorValue[piston]=1;}
